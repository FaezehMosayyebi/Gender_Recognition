...
class FaceComponentsExtractor(object):
    ...
    def all_face_components(self):
        ...
        return self.aligned_face[
            self.eybrowtop : self.lipsbottom, self.eyebrowleft : self.eyebrowright
        ]
    ...
    def lower_part1(self):
        ...
        """
        return self.aligned_face[
            self.eyebottom : self.facebottom, self.faceleft : self.faceright
        ]
    ...
    def lower_part2(self):
        ...
        """
        return self.aligned_face[
            self.eybrowtop : self.facebottom, self.faceleft : self.faceright
        ]
    ...
    def top_part1(self):
        ...
        """
        return self.aligned_face[
            self.aligned_face.top() : self.nosetip[1], self.faceleft : self.faceright
        ]
    ...
    def top_part2(self):
        ...
        """
        return self.aligned_face[
            self.aligned_face.top() : self.nosetip[1],
            self.faceleft : self.righteyeleft[0],
        ]
    ...
    def top_part3(self):
        ...
        return self.aligned_face[
            self.aligned_face.top() : self.nosetip[1],
            self.lefteyeright[0] : self.faceright,
        ]
    ...
    def right_part1(self):
        ...
        """
        return self.aligned_face[
            self.aligned_face.top() : self.facebottom, self.nosetip[0] : self.faceright
        ]
    ...
    def right_part2(self):
        ...
        """
        return self.aligned_face[
            self.aligned_face.top() : self.facebottom,
            self.lefteyeright[0] : self.faceright,
        ]
    ...
    def right_part3(self):
        ...
        """
        return self.aligned_face[
            self.eybrowtop : self.facebottom,
            int(min(self.landmarks[38][0], self.landmarks[40][0])) : self.faceright,
        ]
    ...
    def left_part1(self):
        ...
        """
        return self.aligned_face[
            self.aligned_face.top() : self.facebottom, self.faceleft : self.nosetip[0]
        ]
    ...
    def left_part3(self):
        ...
        return self.aligned_face[
            self.eybrowtop : self.facebottom,
            self.faceleft : int(max(self.landmarks[43][0], self.landmarks[47][0])),
        ]
    ...
    def face_boundary(self):
        ...
        mask = Image.new(
            "L", (self.landmarks.shape[1], self.landmarks.shape[0]), "black"
        )
